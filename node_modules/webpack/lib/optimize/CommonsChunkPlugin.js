		...
		compiler.plugin("this-compilation", (compilation) => {
			compilation.plugin(["optimize-chunks", "optimize-extracted-chunks"], (chunks) => {
				...
				commonChunks.forEach(function processCommonChunk(commonChunk, idx) {
					...
					// console.log('------------->usedChunks',util.inspect(usedChunks, {showHidden:true,depth:3})); 
			     ...
			     //        }),
			           ...
			           //chunks一直是不变的，因为不存在的chunks在最前面已经创建了空的chunks
						usedChunks = chunks.filter((chunk) => {
						 ...
						 // var util = require('util'); 
					  //    console.log('这次使用的chunks事',util.inspect(usedChunks, {showHidden:true,depth:4})); 
					...
					if(asyncOption) {
						...
						for(const chunk of reallyUsedChunks) {
										 var util = require('util'); 
					    console.log('------------->chunk',util.inspect(chunk, {showHidden:true,depth:3})); 
